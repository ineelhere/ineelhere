...
def portfolio():
    ...
    <p  align='center'><i>All things Tech enthusiast, building data web-apps and solving problems with code (with lots of googling, of course!)</i>
    <br><br>
    <i>
