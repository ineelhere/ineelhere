...
def portfolio():
    ...
    <br> Managed Network Expert (Freelance) in Biology at Chegg Inc. <strong>|</strong> <i>Since September 2018</i><br><br><p align='center'><strong>Please select from the sidebar on the left to visit view a few web-apps I have created using python!</strong></p>
