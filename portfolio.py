...
def portfolio():
    ...
    <p  align='center'><i>All things Data enthusiast, building data web-apps and solving problems with code (with lots of googling, of course!)</i>
    <br><br>
    Bioinformatics Engineer at Elucidata Corporation, India. <strong>|</strong> <i>Since June 2021</i>
    <br>Former Research Assistant at IBAB, Bengaluru, India. <strong>|</strong> <i>March 2020 - May 2021</i>
    <br> Managed Network Expert (Freelance) in Biology at Chegg Inc. <strong>|</strong> <i>Since September 2018</i><br><br><p align='center'><strong>Please select from the sidebar on the left to explore a few web-apps I have created using python!</strong></p>
    </p> <h6 class="jumbotron-heading" align = 'center'>
